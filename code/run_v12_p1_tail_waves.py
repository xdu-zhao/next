"""Continue the only high-wave cases whose best point remained at 8."""
...
def main() -> int:
    ...
    trial, incumbent = root / "results_v12_p1_tail_waves", root / "results_v8_n5"
    ...
    (incumbent / "v12_p1_tail_waves_improved_cases.json").write_text(json.dumps(improved, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    ...
    print(f"V12_P1_TAIL_WAVES_COMPLETE improved={len(improved)}", flush=True)
    return 0
