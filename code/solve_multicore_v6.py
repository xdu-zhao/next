...
def candidate_plans(
    ...
    if problem == 1:
        ...
        if mode == "none":
            ...
            # V6: keep the full V5 portfolio, plus a complementary
            # Scene-A neighborhood to test whether some graphs prefer
            # slightly coarser/finer partitions than the 0.60 basin.
            wave_values = [
                0.30,
                0.35,
                0.45,
    ...
    cluster_params = (
        ...
        if mode == "quick"
            ...
            # V6: selected off-diagonal points. These distinguish
            # "more load balance" from "more communication clustering"
            # instead of changing both weights together.
            (0.08, 0.35),
            (0.08, 0.50),
            (0.12, 0.20),
            (0.12, 0.50),
    ...
    if problem == 3 and mode == "full":
        ...
        for cv in (
            # V5 points retained.
            0.35, 0.45, 0.55, 0.65, 0.80, 0.95,
            # V6 tests whether the high-value tail is still improving.
            1.10, 1.30, 1.60,
        ):
            yield (
        ...
        # V6 P3 cross-search: keep cache value in the useful middle range,
        # vary communication clustering independently.
        for cscale, cv in [
            (0.15, 0.55),
            (0.15, 0.80),
            (0.45, 0.55),
